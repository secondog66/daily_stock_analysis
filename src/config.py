...
class Config:
    ...
    serper_api_keys: List[str] = field(default_factory=list)  # Serper.dev API Keys (free 2500 searches)
    ...
    def _load_from_env(cls) -> 'Config':
        ...
        serper_api_keys = [k.strip() for k in serper_keys_str.split(',') if k.strip()]
